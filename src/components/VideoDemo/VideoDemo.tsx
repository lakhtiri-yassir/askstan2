      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-brand-red/10 to-yellow-500/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-3 mb-6">
                <Sparkles className="w-5 h-5 text-brand-red" />
                <span className="text-brand-red-600 font-semibold">Live Demo</span>
              </div>
          ...
          >
            ...
            <div className="absolute -inset-4 bg-gradient-to-br from-brand-red/10 via-purple-500/10 to-yellow-500/10 rounded-3xl blur-xl" />
            ...
            >
              ...
              <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-lg border border-white/20 rounded-xl p-6 shadow-lg">
                <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-brand-red to-brand-red-600 rounded-lg flex items-center justify-center">
