  ...
  const features = [
    {
      ...
      description: 'Get personalized social media strategies powered by advanced AI technology.'
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: 'Growth Analytics',
      description: 'Track your progress with detailed analytics and growth insights.'
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: 'Multi-Platform Support',
      description: 'Optimize your presence across Instagram, TikTok, Twitter, and more.'
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: '24/7 Availability',
      description: 'Get instant advice and support whenever you need it, day or night.'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'AskStan! helped me grow from 1K to 50K followers in just 3 months!',
      rating: 5
    },
    {
      name: 'Mike Chen',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Get personalized coaching, growth strategies, and 24/7 support from our AI-powered social media expert. Transform your online presence today.
              </p>
